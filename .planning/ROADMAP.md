...
- [ ] **Phase 1: Foundation & Preview Engine** - In-memory parsing, header extraction, and auto-recommendation regex.
...
Plans:
- [ ] 01-01: Backend Uvicorn/FastAPI setup with file upload API.
- [ ] 01-02: Preview and auto-detection engine logic (Pandas/openpyxl/regex).
- [ ] 01-03: Frontend React drag-and-drop file upload and preview page.
...
|-------|----------------|--------|-----------|
| 1. Foundation & Preview Engine | 0/3 | Not started | - |
